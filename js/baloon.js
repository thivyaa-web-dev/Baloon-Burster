...
balloon_1.src =
  "https://drive.google.com/uc?export=view&id=0BzIuZOZL5LxeRi1YWmdXNWdjTm8";
var balloon_2 = new Image();
balloon_2.src =
  "https://drive.google.com/uc?export=view&id=0BzIuZOZL5LxeQ0dvS0JZdXFqYkU";
var balloon_3 = new Image();
balloon_3.src =
  "https://drive.google.com/uc?export=view&id=0BzIuZOZL5Lxed0RoajZCMjlvWFk";
var balloon_4 = new Image();
balloon_4.src =
  "https://drive.google.com/uc?export=view&id=0BzIuZOZL5Lxeb3ZGZlBEaUlyMjA";
var balloon_5 = new Image();
balloon_5.src =
  "https://drive.google.com/uc?export=view&id=0BzIuZOZL5LxeMHJ2N1F4OGIzMXM";
var balloon_6 = new Image();
balloon_6.src =
  "https://drive.google.com/uc?export=view&id=0BzIuZOZL5LxeSnlmdURiWmI1dzg";

var pop = new Image();
pop.src =
  "https://drive.google.com/uc?export=view&id=0BzIuZOZL5LxeZ2NIdGthRmM1Mk0";
...
var canvasInit = function (lastTime, animProp, health) {
  ...
  ctx.canvas.addEventListener("mousedown", function (event) {
    ...
    for (var i = 0; i < balloons.length; i++) {
      if (
        mouseY > balloons[i].y &&
        mouseY < balloons[i].y + 48 &&
        mouseX > balloons[i].x &&
        mouseX < balloons[i].x + 35
      ) {
